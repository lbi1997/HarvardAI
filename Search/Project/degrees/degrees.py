...
from Search.Project.degrees.util import Node, StackFrontier, QueueFrontier
...
def shortest_path(source, target):
    ...
    # intialise frontier to starting position
    ...
    while True:
        ...
        # if node is target, we have solution
